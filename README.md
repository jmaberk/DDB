...
This code runs the Bayesian optimisation with the search space defined with the distribution derived boundary (DDB) method. The paper describing the algorithm has been submitted for review to the ECML 2019 conference.
