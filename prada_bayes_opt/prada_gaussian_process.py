...
#                    #print temp_det
    ...
    def optimize_lengthscale_SE(self,previous_theta,noise_delta,bounds):
        """
...
#                val=self.leave_one_out_lengthscale(res.x,noise_delta)  
    ...
    def optimize_lengthscale(self,previous_theta,noise_delta,bounds):
        if self.kernel_name == 'ARD':
            return self.optimize_lengthscale_ARD(previous_theta,noise_delta)
        if self.kernel_name=='SE':
            return self.optimize_lengthscale_SE(previous_theta,noise_delta,bounds)
